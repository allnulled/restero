...
window.PaginaDeAsambleaEditarVotacion = Castelog.metodos.un_componente_vue2("PaginaDeAsambleaEditarVotacion",
  "<div class=\"PaginaDeAsambleaEditarVotacion Component\">"
 + "    <div class=\"window\">"
 + "      <div class=\"title-bar\">"
...
data() {try {
console.log('[DEBUG]', "PaginaDeAsambleaEditarVotacion.data");
...
console.log('[DEBUG]', "PaginaDeAsambleaEditarVotacion.crear_post");
...
console.log('[DEBUG]', "PaginaDeAsambleaEditarVotacion.guardar_post");
...
async mounted() {try {
console.log('[DEBUG]', "PaginaDeAsambleaEditarVotacion.mounted");
