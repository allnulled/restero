...
window.PaginaDeAsambleaEditarSolucionDeVotacion = Castelog.metodos.un_componente_vue2("PaginaDeAsambleaEditarSolucionDeVotacion",
...
data() {try {
console.log('[DEBUG]', "PaginaDeAsambleaEditarSolucionDeVotacion.data");
...
console.log('[DEBUG]', "PaginaDeAsambleaEditarSolucionDeVotacion.crear_post");
...
console.log('[DEBUG]', "PaginaDeAsambleaEditarSolucionDeVotacion.guardar_post");
...
async mounted() {try {
console.log('[DEBUG]', "PaginaDeAsambleaEditarSolucionDeVotacion.mounted");
