...
window.PaginaDeAsambleaEditarProblemaDeVotacion = Castelog.metodos.un_componente_vue2("PaginaDeAsambleaEditarProblemaDeVotacion",
  "<div class=\"PaginaDeAsambleaEditarProblemaDeVotacion Component\">"
 + "    <div class=\"window\">"
 + "      <div class=\"title-bar\">"
...
data() {try {
console.log('[DEBUG]', "PaginaDeAsambleaEditarProblemaDeVotacion.data");
...
console.log('[DEBUG]', "PaginaDeAsambleaEditarProblemaDeVotacion.crear_post");
...
console.log('[DEBUG]', "PaginaDeAsambleaEditarProblemaDeVotacion.guardar_post");
...
async mounted() {try {
console.log('[DEBUG]', "PaginaDeAsambleaEditarProblemaDeVotacion.mounted");
