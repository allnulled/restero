...
window.PaginaDeBlogParaVerPost = Castelog.metodos.un_componente_vue2("PaginaDeBlogParaVerPost",
 ...
 + "              <div v-html=\"post_del_blog.contenido\"></div>"
 + "            </div>"
 + "            <div class=\"tags_de_post\">"
 + "              <div>Tags: {{ post_del_blog.tags }}</div>"
 + "            </div>"
 + "          </div>"
 + "          <div class=\"panel_de_comentarios\" style=\"margin-top: 4px;\">"
 + "            <div class=\"ver_post\">"
 + "              <h5>Ver comentarios</h5>"
 + "              <div style=\"padding: 4px; padding-top: 0px; padding-bottom: 0px;\">"
...
const respuesta_1 = (await Castelog.metodos.una_peticion_http("/api/v1/delete/Comentario_de_post_de_blog", "POST", { id:id_comentario
...
console.log('[DEBUG]', "PaginaDeBlogParaVerPost.eliminar_post");
...
const respuesta_1 = (await Castelog.metodos.una_peticion_http("/api/v1/eliminar_post_de_blog/" + this.post_del_blog.id, "POST", { 
}, { authorization:this.root.token_de_sesion
}, null, null));
this.$window.utilidades.gestion_de_error_desde_respuesta( respuesta_1,
this );
