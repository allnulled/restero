    ...
    return async function (request, response, parametro) {
        try {
            ...
            if (typeof autentificacion !== "object") {
                throw new Error("Autentificación requerida por autorizador «si_insertable_por_mismo_usuario»");
            }
            ...
            console.error("Error en «src/authorizers/si_seleccionable_por_mismo_usuario.js»");
            console.error(error);
            throw error;
        }
    };
